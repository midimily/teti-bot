...
export const EN_MESSAGES = {
  ...
  shell: {
    ...
    openTeti: "Open Teti",
    openPendingTasks: { one: "Open Teti Tasks, # task has an update", other: "Open Teti Tasks, # tasks have updates" },
  ...
  tasks: {
    ...
    header: {
      ...
      detail: "Task details",
      pending: { one: "# task has an update", other: "# tasks have updates" },
    ...
    inbox: {
      ...
      longHorizonStage: "Ongoing collaboration · Stage {stage}"
    },
    composer: {
      peer: "Send to",
    ...
    detail: {
      ...
      latestChangeTitle: "Latest change",
      latestChangeStage: "{change} · Stage {stage}",
      latestChangeAt: "{change} · {date}",
      latestChanges: {
        status_updated: "Task status updated",
        delivery_failed: "Message not delivered yet; retrying automatically",
        delivery_recovered: "The previously undelivered message has now arrived",
        input_received: "Additional instructions received",
        stage_started: "Stage started",
        stage_completed: "Stage completed",
        stage_failed: "Stage failed",
        pause_requested: "Set to pause after this stage",
        cancel_requested: "Cancellation requested",
        paused: "Ongoing collaboration paused",
        resumed: "Ongoing collaboration resumed",
        renewed: "Ongoing collaboration renewed",
      ...
      authorization: {
        ...
        ongoingLoginTitle: "After Agent sign-in · Start ongoing collaboration",
        ongoingAgentTitle: "{agent} · Ongoing collaboration",
        ongoingTitle: "Ongoing collaboration",
        ongoingDetail: "Once accepted, this ongoing collaboration can receive later-stage instructions from the peer. You still confirm each new stage before it runs, until the task is completed, stopped by you, or expires. It grants no authority over other tasks.",
      ...
      actions: {
        ...
        retryOngoingAfterLogin: "Accept after sign-in",
        allowOngoing: "Accept ongoing collaboration",
    ...
    status: {
      ...
      awaitingPeer: "Awaiting peer task acceptance",
    ...
    longHorizon: {
      ...
      workspaceExpiry: "Collaboration available until {date}",
      ...
      structuredMemory: {
        ...
        automaticNote: "Automatically on. The next stage references completed results from this task.",
        collapsedOff: "Off by default",
        collapsedOn: "On · {count} stages",
        collapsedUnavailable: "Local saving unavailable",
        loading: "Reading memory status…",
        unavailable: "This task still references completed stages, but local memory saving is unavailable.",
        readOnly: "{count} stage results are retained in read-only mode.",
        ready: "{count} stage results saved on this device",
        currentTaskOnly: "Used only for this ongoing collaboration. History from other tasks, workspaces, or peers is never added automatically.",
        stage: "Stage {stage}",
        ...
        scopesTitle: "Content the next stage may reference",
        scopes: { task: "This task", workspace: "This workspace", peer: "This peer" },
        scopeEnabled: "Allowed · {count} items",
        scopeDisabled: "Not allowed · {count} items",
        candidatesTitle: "Content available to the next stage",
        candidatesEmpty: "Nothing is available yet. After a stage completes, organize its result before selecting it.",
        ...
        injectNext: "Let the next stage reference the content above",
        injectNote: "Used once only. If content changes or the preview expires, execution continues without memory.",
        refreshPreview: "Refresh preview",
        previewSummary: "Selected {count} items · {bytes} bytes · Agent {agent}",
        lastInjection: "The previous execution referenced {count} items",
        kinds: {
          decision: "Decision",
      ...
      instructionPending: "Sent — waiting for the peer to start the next stage",
      stageLimitReached: "The 16-stage limit has been reached. Wait for the peer to accept the current result and complete the task.",
      ...
      renewing: "Renewing…",
      renewedUntil: "Extended by 1 hour. New deadline: {date}",
      renewFailed: "Could not renew. The renewal count or maximum collaboration lifetime may have been reached; the current deadline did not change.",
