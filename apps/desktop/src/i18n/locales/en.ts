...
export const EN_MESSAGES = {
  ...
  tasks: {
    ...
    longHorizon: {
      ...
      structuredMemory: {
        title: "Optional: collaboration memory",
        automaticNote: "Off by default, so you can start the task immediately. A later stage uses local saved content only after you organize and select it.",
        collapsedOff: "Off by default",
        collapsedOn: "Next stage will reference {count} items",
        collapsedUnavailable: "Unavailable; task unaffected",
        loading: "Reading memory status…",
        unavailable: "Collaboration memory is unavailable, but task approval, execution, and stage results are unaffected.",
        readOnly: "You can view {count} recorded stages, but cannot add or use them for the next stage.",
        ready: "{count} stage results recorded",
        stage: "Stage {stage} · {agent}",
